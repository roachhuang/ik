...
def quiz4_4():
    ...
    # see fig on p2
    Td_0 = np.array([[1, 0, 0, 830], [0, 1, 0, 20], [0, 0, 1, -43],
                     [0, 0, 0, 1]])

    t = np.deg2rad(-60)
    # rotation in y axis
    tc_d = np.array([[cos(t), 0, sin(t), -500], [0, 1, 0, 452],
                     [-sin(t), 0, cos(t), 410], [0, 0, 0, 1]])
    ...
    print('tc_0:', tc_0)
    # real parts only
    tc_w.applyfunc(lambda x: round(x, 2))
    print('tc_w:', tc_w)
...
def quiz4_5(tc_0):
    ...
    print('t6_0', t6_0)
    pp.pieper(t6_0)
    # quiz4: 0.500//-0.866//330//472//0.866//740
    # theta3: -158//-35
